...
import { B as AccountEntity, D as InteractionType, E as InteractionStatus, J as Logger, N as InteractionRequiredAuthError, O as WrapperSKU, Q as AuthError, a as stubbedPublicClientApplication, f as EventType, i as EventMessageUtils, rt as OIDC_DEFAULT_SCOPES } from "./dist-BHmQOjiF.js";
...
function useAccount(accountIdentifiers) {
	...
	(0, import_react.useEffect)(() => {
		if (inProgress !== InteractionStatus.Startup) setAccount((currentAccount) => {
